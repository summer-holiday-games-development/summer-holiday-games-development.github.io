...
function openCard(num) {
    if (openCard1 == null) {   
        document.getElementById(`card${num}`).src = `./matching-game/cards/card${cardsArray[num]}.webp`; 
        openCard1 = num;
        movesCounter ++;
...
function closeCards() {
    if (foundPair === true) {
        ...
        document.getElementById(`foundcard${foundCardCounter}`).src = `./matching-game/cards/card${cardsArray[openCard1]}.webp`;
        foundCardCounter--;
        foundPair = false;
    } else {
        document.getElementById(`card${openCard1}`).src = `./matching-game/card.webp`;
        document.getElementById(`card${openCard2}`).src = `./matching-game/card.webp`;
    }
    openCard1 = null;
    openCard2 = null;
};
...
function startGame() {  
    ...
    for (i=0; i<gameSize*2; i++) {
        ...
        document.getElementById(`card${i}`).src = `./matching-game/card.webp`;
    }
